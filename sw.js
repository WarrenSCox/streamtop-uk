const CACHE='wozzawatch-v6.2.1';
const ASSETS=[
  './news-icon.png',
  './news.json',
  './news.js',
  './read.html','./read.js?v=6.1.6','./read.json','./news.html','./news.js?v=6.1.6','./','./index.html','./tune.html','./tune.js?v=6.1.6','./my-list.html','./my-list.js?v=6.1.6','./watched.html','./watched.js?v=6.1.6','./my-list-icon.svg','./read-icon.svg','./news-icon.svg','./tune-icon.svg','./single-icon.svg','./single-icon.svg','./album-icon.svg','./album-icon.svg','./styles.css?v=6.1.6','./app.js?v=6.1.6','./manifest.webmanifest','./icon.svg','./ear-icon.svg'];
