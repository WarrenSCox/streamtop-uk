const CACHE='wozzawatch-v6.1.5';
const ASSETS=[
  './news-icon.png',
  './news.json',
  './news.js',
  './read.html','./read.js?v=6.1.5','./read.json','./news.html','./news.js?v=6.1.5','./','./index.html','./tune.html','./tune.js?v=6.1.5','./my-list.html','./my-list.js?v=6.1.5','./watched.html','./watched.js?v=6.1.5','./my-list-icon.svg','./read-icon.svg','./news-icon.svg','./tune-icon.svg','./single-icon.svg','./single-icon.svg','./album-icon.svg','./album-icon.svg','./styles.css?v=6.1.5','./app.js?v=6.1.5','./manifest.webmanifest','./icon.svg'];
