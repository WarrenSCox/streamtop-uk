const CACHE='wozzawatch-v6.1.2';
const ASSETS=[
  './news-icon.png',
  './news.json',
  './news.js',
  './read.html','./read.js?v=6.1.2','./read.json','./news.html','./news.js?v=5.3.41','./','./index.html','./tune.html','./tune.js?v=5.3.39','./my-list.html','./my-list.js?v=5.3.39','./watched.html','./watched.js?v=5.3.39','./my-list-icon.svg','./read-icon.svg','./news-icon.svg','./tune-icon.svg','./single-icon.svg','./single-icon.svg','./album-icon.svg','./album-icon.svg','./styles.css?v=6.1.2','./app.js?v=5.3.39','./manifest.webmanifest','./icon.svg'];
