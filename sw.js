const CACHE='wozzawatch-v5.3.39.0';
const ASSETS=[
  './news-icon.png',
  './news.json',
  './news.js',
  './news.html','./','./index.html','./tune.html','./tune.js?v=5.3.39','./my-list.html','./my-list.js?v=5.3.39','./watched.html','./watched.js?v=5.3.39','./my-list-icon.svg','./read-icon.svg','./news-icon.svg','./tune-icon.svg','./single-icon.svg','./single-icon.svg','./album-icon.svg','./album-icon.svg','./styles.css?v=5.3.39','./app.js?v=5.3.39','./manifest.webmanifest','./icon.svg'];
